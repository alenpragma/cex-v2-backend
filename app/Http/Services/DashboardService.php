...
class DashboardService
{
    ...
    public function getOrderDataForUser($request, $userId)
    {
        ...
        $baseCoinData = $this->getCoinPairForUser($baseCoinId, $tradeCoinId, $userId);
        ...
        $wallet = $walletService->getBalance($userId, $baseCoinData->parent_coin_id);
        ...
        $tradeFees = $this->tradeFeeFinderService->findTradeFee($baseCoinId, $tradeCoinId, $userId);
        ...
        $onOrder = $this->getOnOrderBalance($baseCoinId, $tradeCoinId, $userId);
    ...
    public function getOrdersForUser($request, $userId)
    {
        $response = [
            'status' => false,
            'message' => __('Something went wrong'),
        ...
        try {
            ...
            if ($request->order_type == 'sell') {
                ...
                if (isset($request->dashboard_type) && $request->dashboard_type == 'dashboard') {
                    $data['orders'] = $this->sellOrderRepository->getAllOrdersForUser($request->base_coin_id, $request->trade_coin_id, $userId)->limit($perPage)->get();
                ...
                if (isset($request->dashboard_type) && $request->dashboard_type == 'dashboard') {
                    $data['orders'] = $this->buyOrderRepository->getAllOrdersForUser($request->base_coin_id, $request->trade_coin_id, $userId)->limit($perPage)->get();
                    if (isset($data['orders'][0])) {
                        $highestPrice = getHighestPriceFromOrderList($data['orders']);
                        getOrderPricePercentage($data['orders'], $highestPrice);
                    }
                } else {
                    $data['orders'] = $this->buyOrderRepository->getAllOrdersForUser($request->base_coin_id, $request->trade_coin_id, $userId);
                }
                $data['order_type'] = 'buy';
                ...
                if (isset($request->dashboard_type) && $request->dashboard_type == 'dashboard') {
                    $data['buy_orders'] = $this->buyOrderRepository->getAllOrdersForUser($request->base_coin_id, $request->trade_coin_id, $userId)->limit($perPage)->get();
                    ...
                    $data['sell_orders'] = $this->sellOrderRepository->getAllOrdersForUser($request->base_coin_id, $request->trade_coin_id, $userId)->limit($perPage)->get();
                    ...
                    $data['buy_orders'] = $this->buyOrderRepository->getAllOrdersForUser($request->base_coin_id, $request->trade_coin_id, $userId)->paginate($perPage)->appends($request->all());
                    $data['sell_orders'] = $this->sellOrderRepository->getAllOrdersForUser($request->base_coin_id, $request->trade_coin_id, $userId)->paginate($perPage)->appends($request->all());
                }
    ...
    public function getDashboardMarketTradeDataTwo($base_coin_id, $trade_coin_id, $limit)
    {
        ...
        if ($data) {
            ...
            $coinPairData = checkPair($base_coin_id, $trade_coin_id);
            $output = [];
    ...
    public function getAllOrderSocketDataForUser($request, $userId)
    {
        $data['order_data'] = $this->getOrderDataForUser($request, $userId)['data'];
        //        $data['last_price_data'] = $this->getDashboardMarketTradeDataTwo($request->base_coin_id, $request->trade_coin_id,2);
        $data['orders'] = $this->getOrdersForUser($request, $userId)['data'];
